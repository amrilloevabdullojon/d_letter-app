    ...
    <div className="hidden shrink-0 items-center gap-1 md:flex">
      ...
      {primaryAction && (
        <Link
          ...
          className="mr-1 inline-flex items-center gap-2 rounded-lg bg-gradient-to-r from-teal-500 to-emerald-600 px-3 py-1.5 text-sm font-medium text-white shadow-lg shadow-teal-500/25 transition-all hover:shadow-teal-500/40 hover:brightness-110"
        >
      ...
      {/* Search — icon only button, compact */}
      <button
      ...
      {user && (
        <>
          ...
          {/* Profile Link — avatar + role badge absolute */}
          <Link
            href="/profile"
            onClick={(event) => handleNavClick(event, '/profile')}
            className="group relative ml-0.5 flex h-8 w-8 shrink-0 items-center justify-center rounded-full"
          ...
          <button
            ...
            className="flex h-8 w-8 items-center justify-center rounded-lg text-slate-400 transition-all hover:bg-red-500/10 hover:text-red-400"
