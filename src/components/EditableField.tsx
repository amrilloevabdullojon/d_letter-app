      ...
      <div className="mb-4">
        ...
        {type === 'textarea' ? (
          <textarea
            ...
            className="w-full resize-none rounded-lg border border-slate-600/50 bg-slate-700/50 px-4 py-2 text-white placeholder-slate-500 focus:border-teal-500 focus:outline-none focus:ring-1 focus:ring-teal-500/30"
          />
        ) : (
          <input
            type={type}
            ...
            onChange={(e) => setNewValue(e.target.value)}
            placeholder={placeholder}
            className="w-full rounded-lg border border-slate-600/50 bg-slate-700/50 px-4 py-2 text-white placeholder-slate-500 focus:border-teal-500 focus:outline-none focus:ring-1 focus:ring-teal-500/30"
          />
        )}
    ...
    <div className="group mb-4">
      <div className="flex items-center justify-between">
        ...
        <button
          ...
          className="p-1 text-slate-600 opacity-0 transition hover:text-slate-400 group-hover:opacity-100"
        >
